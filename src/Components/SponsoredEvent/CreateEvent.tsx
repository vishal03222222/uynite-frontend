...
//   // ^ "true" means we start with the form in "create" mode.
...
//   const menuItems = [
//     {
//       label: "Create Event and list",
//       onClick: () => handleMenuClick("Create Event and list"),
//       active: activeMenu === "Create Event and list",
//     },
//     {
//       label: "Up Comming Events",
//       onClick: () => handleMenuClick("Up Comming Events"),
//       active: activeMenu === "Up Comming Events",
//     },
//     {
//       label: "On Going Event",
//       onClick: () => handleMenuClick("On Going Event"),
//       active: activeMenu === "On Going Event",
//     },
//     {
//       label: "Completed Events",
//       onClick: () => handleMenuClick("Completed Events"),
//       active: activeMenu === "Completed Events",
//     },
//   ];

//   // ---- Helper to handle file input for each image ----
...
//   // ---- Switch to "edit" mode, re-show the form ----
//   const handleEdit = () => {
//     setIsEditing(true);
//   };

//   return (
//     <div className="min-h-screen bg-gradient-to-r from-gray-100 to-gray-300 p-1 flex mt-20">
//       {/* Sidebar */}
